...
--- @param locale string @ Name of the locale to register, e.g. "enUS", "deDE", etc.
...
--- @param silent boolean @ If true, the locale will not issue warnings for missing keys. Must be set on the first locale registered. If set to "raw", nils will be returned for unknown keys (no metatable used).
--- @usage
--- -- enUS.lua
